...
function renderAuthForm() {
  ...
  document.getElementById('auth-body').innerHTML = `
    ...
    <a href="/auth/google" class="social-btn" style="text-decoration:none;margin-bottom:10px;display:flex;align-items:center;justify-content:center;gap:12px;padding:13px;border-radius:var(--r-md);border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.05);color:var(--text-1);font-family:var(--font-d);font-weight:600;font-size:.9rem">
    ...
    <a href="#" class="social-btn" style="text-decoration:none;margin-bottom:10px;display:flex;align-items:center;justify-content:center;gap:12px;padding:13px;border-radius:var(--r-md);border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.05);color:var(--text-1);font-family:var(--font-d);font-weight:600;font-size:.9rem" onclick="handleApple(event)">
